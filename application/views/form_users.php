...
<div class="col-12 mt-6">
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                <!-- nama lengkap -->
                <label for="kk">Nama Lengkap</label>

                <!-- tampilan -->
                <?php echo form_input("nama_lengkap", set_value('nama_lengkap'), array(
    ...
    <div class="form-group">
        ...
        <!-- tampilan -->
        <?php echo form_radio('level', 'admin', set_value('level')) ?>User
        <?php echo form_radio('level', 'user', set_value('level')) ?>Admin
        </br>
        <!-- validasi cek -->
        <small class="text-danger">
            <!-- dismiss alert area start -->
